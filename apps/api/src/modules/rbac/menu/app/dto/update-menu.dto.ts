import type { IUpdateMenuDTO } from '@packages/types'
...
import { MENU_ACTION, MENU_COMPONENT, MENU_DOMAIN, MENU_ICON, MENU_NAME, MENU_PATH, MENU_QUERY } from '../../domain'

/** 更新菜单接口参数校验 */
@ApiSchema({ description: '更新菜单接口参数校验' })
